...
function apply(ctx, config = {}) {
	const c = ctx;
	if (typeof c.provide !== "function") throw new Error("hive-fed-host: host context does not expose provide(); not a cordis context");
