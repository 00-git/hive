...
const SEAT_KEY = 'hive-fed-host#hive-fed-host/host'
...
/**
 * Mount the row's configuration seat while the Host serves this namespace, and
 * retire it when the namespace goes away.
