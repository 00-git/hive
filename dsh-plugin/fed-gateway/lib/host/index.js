...
//#endregion
//#region src/vendor/schemastery.mjs
...
//#endregion
//#region src/settings-gateway.ts
/**
...
*/
const GATEWAY_SETTINGS_NS = "hive-gateway";
...
function apply(ctx, config = {}) {
	const c = ctx;
	if (typeof c.provide !== "function") throw new Error("hive-fed-gateway: host context does not expose provide(); not a cordis context");
...
//#endregion
export { GatewayServer, apply, name };
